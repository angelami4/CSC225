...
public class BattleScreen2 extends Screen
{
    ...
    public void initialize() {
        ...
        enemyHP = new SpriteFont("ENEMY | " + GamePanel.bossHealth2 + " HP", 600, 15, "Trebuchet MS", 22, Color.white);
        ...
        if (Keyboard.isKeyDown(Key.ESC) && !keyLocker.isKeyLocked(Key.ESC)) {
            ...
            if (Keyboard.isKeyDown(Key.ENTER) && !keyLocker.isKeyLocked(Key.ENTER)) {
                ...
                if (selectedAttack == 0) {
                    ...
                    {
                        GamePanel.bossHealth2 -= 10;
                        enemyHP.setText("ENEMY | " + GamePanel.bossHealth2 + " HP");
                    } 
